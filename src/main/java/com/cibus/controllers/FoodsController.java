...
public class FoodsController implements ModelDriven<Object>, SessionAware {
  ...
  public HttpHeaders index() throws Exception {
    final var repo = new FoodRepository(Database.getConnection());
  ...
  public HttpHeaders create() throws Exception {
    final var FoodsRepo = new FoodRepository(Database.getConnection());
    final var usersRepo = new UserRepository(Database.getConnection());
